...
Prompt = f"""Given an input question, first create a syntactically correct {dialect} query to run, always show distinct and maximum 10 rows until user ask for all data.
